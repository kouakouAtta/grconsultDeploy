...
$(document).ready(function(){$("#bordereaux-datatable").DataTable(
{
    iDisplayLength: 10,
    sAjaxSource: basePath + '/ajax/bordereaux',
    sServerMethod: 'post',
...
function getBtn(id){
    ...
    var btnDelete = 
            "        <a href='"+basePath+"/bordereau/voir-details/"+id+"' data-toggle='tooltip' data-placement='top' title='Voir les détails' " +
            "            class='btn btn-outline-info btn-rounded waves-effect waves-light'> " +
            "             <i class='feather-eye'></i> " +
            "        </a> ";
    
    btnDelete += 
            "        <a href='"+basePath+"/bordereaux/modifier/"+id+"' data-toggle='tooltip' data-placement='top' title='Modifier l\'élément' " +
