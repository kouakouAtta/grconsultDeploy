...
class PermissionController extends AbstractActionController 
{
    ...
    public function ajouterAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('La permission a été ajouter avec succès.');
    ...
    public function modifierAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add a flash message.
                $this->flashMessenger()->addSuccessMessage('La permission a été modifiée avec succès.');
    ...
    public function supprimerAction()
    {
        ...
        // Add a flash message.
        $this->flashMessenger()->addSuccessMessage('La permission a été supprimée.');
