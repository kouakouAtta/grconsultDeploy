...
!function(e)
{
    ...
    t.prototype.init=function(){
        if(e.isFunction(e.fn.fullCalendar)){
            e("#external-events .fc-event").each(
                function(){
                ...
                e("#calendar").fullCalendar(
                    {header:{
                        ...
                        drop:function(t,a){
                            ...
                            r=e.extend({},n);r.start=t,
                            r.allDay=a,e("#calendar").fullCalendar("renderEvent",r,!0),
                            ...
                            e("#add_event_form").on("submit",function(t){
                                ...
                                if(n.length>=3){
                                    ...
                                    var i={title:e.trim(e("#"+r).text())};
                                    e("#"+r).data("eventObject",i),
                                    e("#"+r).draggable(
                                        {
                                            revert:!0,
                                            revertDuration:0,
                            ...
                            e.CalendarPage=new t,
                            e.CalendarPage.Constructor=t
                        }
